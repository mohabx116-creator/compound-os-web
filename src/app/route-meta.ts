...
export const routeMeta: RouteMeta[] = [
  ...
  { path: ROUTES.ANNOUNCEMENTS, title: 'الإعلانات', purpose: 'استعراض تنبيهات وإعلانات إدارة الكمباوند.' },
  ...
  { path: ROUTES.RULES, title: 'قواعد المجتمع', purpose: 'تقديم اللوائح والسلوكيات المنظمة للحياة داخل الكمباوند.' },
