...
export const mockFacilities: Facility[] = [
  ...
  },
  {
    ...
    rules: [
      'يتطلب الحجز موافقة مسبقة من إدارة الكمبوند قبل موعد الفعالية بـ ٤٨ ساعة.',
...
export const mockDocuments: DocumentFile[] = [
  {
    id: 'doc-901',
    title: 'اللائحة التنظيمية الداخلية للكمبوند',
...
export const mockCommunityRules: string[] = [
  ...
  'الحد الأقصى للسرعة المسموح بها للمركبات داخل الطرق الداخلية للكمبوند هي ٢٠ كم/ساعة حرصاً على سلامة المشاة والأطفال.',
...
export const mockFAQ: FAQItem[] = [
  ...
  },
  {
    ...
    answer: 'الأعطال والصيانة في الأجزاء والمرافق المشتركة للكمبوند مجانية بالكامل ومشمولة برسوم الصيانة السنوية. أما خدمات الصيانة الخاصة بالفلل والشقق من الداخل (مثل سباكة الحمامات الخاصة أو التكييف المنزلي) فهي تخضع لرسوم تقديرية تحدد بعد معاينة الفني للخلل.',
  },
];
